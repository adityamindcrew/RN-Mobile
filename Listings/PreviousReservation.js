...
import { OTHER_USER_PROFILE } from "../../navigation/RouteNames";
...
const PreviousReservation = ({ navigation, route }) => {
  ...
  useEffect(() => {
    const unsubscribe = navigation.addListener("focus", () => {
      dispatch(updateReservationType(3));
    });
        ...
        <EmptyCard>
          <View style={styles.contentSet}>
            ...
            <Typography.ChileLine
              ...
              fontweight={500}
            >
              {data[0]?.bookingId?.listingId.guests + " guests"}
            </Typography.ChileLine>
          </View>
        </EmptyCard>
        <View style={styles.saparator} />
        <EmptyCard>
          <View style={styles.contentSet}>
            ...
            <View style={styles.priceContainer}>
              ...
              >
                {currencyType.symbol}
                {priceFormat(currencyPrice)} x {diffInDays} night
              </Typography.ChileLine>
          ...
          <View style={styles.imgHostView}>
            ...
            <View style={styles.hostNameView}>
              <Typography.ChileLine
                ...
                fontweight={700}
              >
                Previous reservation by {data[0]?.bookingId?.userId.firstName}
              </Typography.ChileLine>
            </View>
          </View>
...
export default PreviousReservation;
