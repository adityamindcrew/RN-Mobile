...
const PreviewListing = ({ navigation, route }) => {
  ...
  const placeImages = summary.images;
      ...
      <ScrollView ref={scrollViewRef}>
        ...
        <EmptyCard>
          ...
          <View style={styles.apartmentDes}>
            ...
            {/* <Text style={styles.houseText}>Located at centre of New York</Text> */}
          </View>
        </EmptyCard>
            ...
            <EmptyCard>
              <TouchableWithoutFeedback
                onPress={() => {
                  ...
                  navigation.navigate("InfoForGuest", { editable: false });
                }}
              >
        ...
        <EmptyCard>
          ...
          >
            ...
            >{`${currencyCode}${summary.price}`}</Text>
          </View>
        </EmptyCard>
        {/* <Seperator seperate={10} />
        <View
